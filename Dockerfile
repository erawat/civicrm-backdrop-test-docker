...
RUN service mysql restart && \
    ...
    su - buildkit -c "/buildkit/civicrm-buildkit/bin/civibuild create backdrop-clean --civi-ver 5.19.4" && \
    rm -rf /tmp/*

ENV PATH="/buildkit/civicrm-buildkit/bin:$PATH"
ENV CIVICRM_SETTINGS=/buildkit/civicrm-buildkit/build/backdrop-clean/web/sites/default/civicrm.settings.php
